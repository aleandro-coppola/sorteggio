...
| 🥃 **Shot Minato** | Campo minato **10×10** in versione alcolica, **senza bombe**: si beve, non si muore. La ruota decide l'ordine, poi si scava. Tessere: 🥃 **shot diretti** (vodka/gin/assenzio, 2 per membro), 🎰 **box roulette** (gira la ruota: beve un membro, «2 SHOT!» a chi ha aperto, o «LIBERO»), 📦 **box a scelta** (ognuno pesca una casella, una sola nasconde lo shot), ⚠️ **rischio bevuta** (al **2°** trovato beve tutta la tavola, poi si azzera), 🪞 **specchio** (copi l'ultimo shot risolto), 🥂 **salute** (tutti bevono subito insieme), 🎯 **'o meno fesso** (beve chi ha bevuto meno shot finora) e 🃏 **jolly** = immunità (solo **4** in tutto) da tenere e usare per saltare una bevuta. Ogni pallino segna gli shot bevuti da ciascuno. La partita **resta in memoria** anche se cambi gioco; il tasto **RESET** ricomincia da capo. |
...
| ♠️ **Carte** | Griglia **8×8** di 64 carte da poker coperte: ognuno ne pesca una a caso (a turno). La **più alta vince**, l'**Asso vale 1**. In caso di **pareggio** sulla carta più alta scatta la regola **«Quando fuori piove»** per quel valore (dalla cascata dell'Asso al bicchiere di mezzo del Re). |
