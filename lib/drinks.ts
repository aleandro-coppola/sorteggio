...
const RAW: [string, Categoria, number, number, string?][] = [
  ...
  // ── Cocktail (gradazione "effettiva": alcol puro / volume totale) ──
  ["Aperol Spritz", "Cocktail", 8.0, 180, "🍊"],
  ["Spritz Campari", "Cocktail", 10.0, 175, "🍊"],
  ["Mimosa", "Cocktail", 6.0, 140],
  ["Sex on the Beach", "Cocktail", 10.0, 200],
  ["Moscow Mule", "Cocktail", 9.0, 200],
  ["Tequila Sunrise", "Cocktail", 9.0, 200],
  ["Cuba Libre", "Cocktail", 10.0, 200],
  ["Gin Tonic", "Cocktail", 10.0, 200],
  ["Bloody Mary", "Cocktail", 10.0, 180, "🍅"],
  ["Mojito", "Cocktail", 10.0, 200, "🍸"],
  ["Piña Colada", "Cocktail", 10.0, 200],
  ["Gin Lemon", "Cocktail", 11.0, 200],
  ["Vodka Lemon", "Cocktail", 11.0, 200],
  ["Americano", "Cocktail", 8.0, 150],
  ["Mai Tai", "Cocktail", 18.0, 150],
  ["Caipirinha", "Cocktail", 16.0, 150],
  ["Daiquiri", "Cocktail", 22.0, 110, "🍸"],
  ["Long Island Iced Tea", "Cocktail", 11.0, 250],
  ["Negroni", "Cocktail", 27.0, 90, "🍸"],
  ["Margarita", "Cocktail", 20.0, 120, "🍸"],
  ["Cosmopolitan", "Cocktail", 17.0, 120, "🍸"],
  // ── Shot & Liquori ──
  ...
  ["4 Bianchi", "Shot & Liquori", 40.0, 50, "⚪"],
  ["4 Bianchi con Baileys", "Shot & Liquori", 32.0, 70, "🥛"],
