...
export const EVENTI: Evento[] = [
  ...
  },
  {
    ...
    testo: ([a, b]) => `${a} contro ${b}: tirate 'o dado! 'O cchiù basso s'a beve. Veloce!`,
    penitenza: "Dado basso: bevi tu.",
  },
  {
    id: "monetina",
    titolo: "'A Monetina",
    ...
    dc: 11,
    scegli: (ctx) => [pickRandom(ctx.players, ctx.rng)],
    testo: ([n]) => `Testa o croce pe' ${n}! Tira: si esce basso (croce), bevi.`,
    penitenza: "È asciuta croce: giù 'o sorso!",
    premio: "Testa! Te sî sarvato.",
  },
  {
    id: "dado-assassino",
    titolo: "'O Dado Assassino",
    emoji: "🎯",
    tipo: "solo",
    dc: 9,
    scegli: (ctx) => [pickRandom(ctx.players, ctx.rng)],
    testo: ([n]) => `${n}, tira 'o dado d''a morte: si è troppo basso, bevi!`,
    penitenza: "Numero 'e sfortuna: bevi!",
    premio: "Dado auto: sarvo pe' stavota.",
  },
  {
    id: "sfortuna",
